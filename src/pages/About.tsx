  ...
  return (
    <Box sx={{ flexGrow: 1, width: '100vw', overflowX: 'hidden' }}>
        ...
        <Paper elevation={3} sx={{ p: 4 }}>
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body1" paragraph>
                1. Autenticidade: Promovemos experiências genuínas que refletem a verdadeira essência de cada local.
              </Typography>
              <Typography variant="body1" paragraph>
                2. Sustentabilidade: Incentivamos práticas de turismo que respeitam e preservam o meio ambiente e as culturas locais.
              </Typography>
              <Typography variant="body1" paragraph>
                3. Comunidade: Valorizamos a conexão entre viajantes e comunidades locais, fomentando o intercâmbio cultural.
              </Typography>
              <Typography variant="body1" paragraph>
                4. Inovação: Buscamos constantemente novas formas de melhorar a experiência de viagem para todos os envolvidos.
              </Typography>
            </Grid>
          </Grid>
        </Paper>
      ...
      <Box sx={{ bgcolor: 'primary.main', color: 'primary.contrastText', py: 6, px: 2, textAlign: 'center' }}>
        ...
        <Typography variant="body1" paragraph>
          Descubra as joias escondidas e histórias não contadas da sua área. Vamos viajar juntos!
        </Typography>
      </Box>
